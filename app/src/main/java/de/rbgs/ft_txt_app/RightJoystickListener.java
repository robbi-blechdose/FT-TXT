 ...
 */
public class RightJoystickListener implements JoystickView.OnMoveListener
{
    private static final int pivotLimit = 30;

    private Main main;

    public RightJoystickListener(Main main)
    {
        super();
        this.main = main;
    }
    ...
    public void onMove(int angle, int strength)
    {
        if(main.isOnline())
        {
            ...
            main.setMotorSpeed(3, leftMotor);
            main.setMotorSpeed(4, rightMotor);
        }
    }
